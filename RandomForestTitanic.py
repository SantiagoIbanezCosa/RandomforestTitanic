...
def main():
    ...
    # Guardar el modelo
    joblib.dump(model, 'modelo_random_forest_titanic.pkl')
    ...
    save_predictions('C:/Users/Santiago/Desktop/PruebasCienciaDeDatos/titanic/predictions_random_forest.csv', passenger_ids, predictions)
